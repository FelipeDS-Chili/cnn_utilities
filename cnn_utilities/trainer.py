...
from cnn_utilities.encoders import OptimizeDf
...
MODEL_NAME = 'cnn_utilities'

MODEL_VERSION = 'v1'

STORAGE_LOCATION = 'models/cnn_utilities/model.joblib'



class Trainer(object):
    ESTIMATOR = "LogisticRegression"
    EXPERIMENT_NAME = "cnn_utilities"
